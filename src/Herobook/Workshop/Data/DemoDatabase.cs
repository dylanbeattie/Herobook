...
namespace Herobook.Workshop.Data {
    public class DemoDatabase : IDatabase {
        private static IList<Profile> profiles;
        private static IList<Friendship> friendships;
        private static IList<Status> statuses;
        private static IList<Photo> photos;

        private static Func<string,string> qualify;

        private static readonly JsonSerializerSettings settings = new JsonSerializerSettings {
            ContractResolver = new CamelCasePropertyNamesContractResolver(),
            Formatting = Formatting.Indented
        };
        private static void Initialize(IHostingEnvironment environment) {
            qualify = path => Path.Combine(Path.Combine(environment.ContentRootPath, "App_Data"), path);
        ...
        public DemoDatabase(IHostingEnvironment hostingEnvironment) {
        ...
        // private string Qualify(string filePath) {
